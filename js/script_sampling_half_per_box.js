...
const pcsPerBoxHalf = Math.floor(pcsPerBoxVal / 2);
const boxesToOpen = Math.ceil(plan.sampleSize / pcsPerBoxHalf);
const pcsPerOpenedBox = pcsPerBoxHalf;
...
samplingInstructions = `
  ...
  <ul>
    <li>Open <strong>${boxesToOpen}</strong> box(es) (from ${numBoxesVal} total).</li>
    <li>From each opened box, inspect <strong>${pcsPerOpenedBox}</strong> piece(s), equal to 50% of the box content.</li>
  </ul>
